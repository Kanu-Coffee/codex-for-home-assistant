...
- 구현 시점의 공식 `home-assistant/apps-example` 및 Home Assistant base image를 확인
- amd64에서 먼저 검증
...
1. 공식 release artifact를 버전/아키텍처별로 다운로드하고 checksum 검증
...
웹/SSH shell 모두 아래를 일관되게 가져야 한다.
