...
- 수용 경계: 실제 HAOS `0.4.0` Configuration UI popup 행렬, top-level global-never precedence, AppArmor `127.0.0.1:8099` dashboard와 live update 감지는 **NOT RUN**이며 자동·공개 이미지 증거로 대체하지 않는다.
