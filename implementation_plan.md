...
- public 0.3.0 read-only audit의 catalog FAIL과 진단 손실은 0.3.1에서 자동 회귀로 보완했지만, 후속 public 0.3.1 실제 HAOS에서는 automation-related 30건 중 2건의 Core `unknown_error`로 catalog가 다시 FAIL했다. 0.3.2 자동 후보와 실제 HAOS 공개 image 재시험을 구분하고 live 완료로 조기 승격하지 않는다.
